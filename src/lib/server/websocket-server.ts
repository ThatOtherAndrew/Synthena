 ...
 * Handles upgrade requests, connection management, and message routing.
 * Reusable in both development (Vite) and production (custom server).
 *
 * @param httpServer - Node.js HTTP server instance to attach WebSocket server to
 * @returns WebSocketServer instance for cleanup
 */
